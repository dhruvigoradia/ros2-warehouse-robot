...
bool control_msgs__msg__joint_trajectory_controller_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // speed_scaling_factor
    PyObject * field = PyObject_GetAttrString(_pymsg, "speed_scaling_factor");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->speed_scaling_factor = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
PyObject * control_msgs__msg__joint_trajectory_controller_state__convert_to_py(void * raw_ros_message)
{
  ...
  {  // speed_scaling_factor
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->speed_scaling_factor);
    {
      int rc = PyObject_SetAttrString(_pymessage, "speed_scaling_factor", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
