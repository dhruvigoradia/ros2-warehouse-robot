...
bool cdr_serialize_control_msgs__msg__MultiDOFCommand(
  const control_msgs__msg__MultiDOFCommand * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_control_msgs
bool cdr_deserialize_control_msgs__msg__MultiDOFCommand(
  eprosima::fastcdr::Cdr & cdr,
  control_msgs__msg__MultiDOFCommand * ros_message)
{
  // Field name: dof_names
  {
    uint32_t cdrSize;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_control_msgs
bool cdr_serialize_key_control_msgs__msg__MultiDOFCommand(
  const control_msgs__msg__MultiDOFCommand * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: dof_names
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_control_msgs
size_t get_serialized_size_key_control_msgs__msg__MultiDOFCommand(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _MultiDOFCommand__ros_msg_type * ros_message = static_cast<const _MultiDOFCommand__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_control_msgs
size_t max_serialized_size_key_control_msgs__msg__MultiDOFCommand(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const control_msgs__msg__MultiDOFCommand * ros_message = static_cast<const control_msgs__msg__MultiDOFCommand *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_control_msgs__msg__MultiDOFCommand(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  control_msgs__msg__MultiDOFCommand * ros_message = static_cast<control_msgs__msg__MultiDOFCommand *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_control_msgs__msg__MultiDOFCommand(cdr, ros_message);
}
