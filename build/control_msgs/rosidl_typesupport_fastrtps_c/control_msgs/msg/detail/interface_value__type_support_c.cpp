  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const control_msgs__msg__InterfaceValue * ros_message = static_cast<const control_msgs__msg__InterfaceValue *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_control_msgs__msg__InterfaceValue(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  control_msgs__msg__InterfaceValue * ros_message = static_cast<control_msgs__msg__InterfaceValue *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_control_msgs__msg__InterfaceValue(cdr, ros_message);
}
