  ...
  size_t current_alignment)
{
  ...
  // Field name: rw_rate
  {
    size_t item_size = sizeof(ros_message->rw_rate);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const controller_manager_msgs__msg__HardwareComponentState * ros_message = static_cast<const controller_manager_msgs__msg__HardwareComponentState *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_controller_manager_msgs__msg__HardwareComponentState(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  controller_manager_msgs__msg__HardwareComponentState * ros_message = static_cast<controller_manager_msgs__msg__HardwareComponentState *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_controller_manager_msgs__msg__HardwareComponentState(cdr, ros_message);
}
