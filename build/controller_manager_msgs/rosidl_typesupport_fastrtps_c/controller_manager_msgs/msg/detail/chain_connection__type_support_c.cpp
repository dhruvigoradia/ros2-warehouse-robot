  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const controller_manager_msgs__msg__ChainConnection * ros_message = static_cast<const controller_manager_msgs__msg__ChainConnection *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_controller_manager_msgs__msg__ChainConnection(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  controller_manager_msgs__msg__ChainConnection * ros_message = static_cast<controller_manager_msgs__msg__ChainConnection *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_controller_manager_msgs__msg__ChainConnection(cdr, ros_message);
}
