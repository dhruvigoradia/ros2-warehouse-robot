...
#include "rosidl_runtime_c/string.h"  // claimed_interfaces, exported_state_interfaces, name, reference_interfaces, required_command_interfaces, required_state_interfaces, state, type
#include "rosidl_runtime_c/string_functions.h"  // claimed_interfaces, exported_state_interfaces, name, reference_interfaces, required_command_interfaces, required_state_interfaces, state, type

// forward declare type support functions

bool cdr_serialize_controller_manager_msgs__msg__ChainConnection(
  const controller_manager_msgs__msg__ChainConnection * ros_message,
  eprosima::fastcdr::Cdr & cdr);

bool cdr_deserialize_controller_manager_msgs__msg__ChainConnection(
  eprosima::fastcdr::Cdr & cdr,
  controller_manager_msgs__msg__ChainConnection * ros_message);
...
bool cdr_serialize_key_controller_manager_msgs__msg__ChainConnection(
  const controller_manager_msgs__msg__ChainConnection * ros_message,
  eprosima::fastcdr::Cdr & cdr);

size_t get_serialized_size_key_controller_manager_msgs__msg__ChainConnection(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_key_controller_manager_msgs__msg__ChainConnection(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: exported_state_interfaces
  {
    size_t size = ros_message->exported_state_interfaces.size;
    auto array_ptr = ros_message->exported_state_interfaces.data;
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      const rosidl_runtime_c__String * str = &array_ptr[i];
      if (str->capacity == 0 || str->capacity <= str->size) {
  ...
  // Field name: chain_connections
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_controller_manager_msgs__msg__ChainConnection(
        &array_ptr[i], cdr);
    }
  }
  ...
  controller_manager_msgs__msg__ControllerState * ros_message)
{
  ...
  // Field name: exported_state_interfaces
  {
    ...
    cdr >> cdrSize;
    size_t size = static_cast<size_t>(cdrSize);
    if (ros_message->exported_state_interfaces.data) {
      rosidl_runtime_c__String__Sequence__fini(&ros_message->exported_state_interfaces);
    }
    if (!rosidl_runtime_c__String__Sequence__init(&ros_message->exported_state_interfaces, size)) {
      fprintf(stderr, "failed to create array for field 'exported_state_interfaces'");
      return false;
    }
    auto array_ptr = ros_message->exported_state_interfaces.data;
    for (size_t i = 0; i < size; ++i) {
      ...
      bool succeeded = rosidl_runtime_c__String__assign(
        ...
        tmp.c_str());
      if (!succeeded) {
        fprintf(stderr, "failed to assign string into field 'exported_state_interfaces'\n");
        return false;
      }
    }
  }
  ...
  // Field name: chain_connections
  {
    ...
    auto array_ptr = ros_message->chain_connections.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_controller_manager_msgs__msg__ChainConnection(cdr, &array_ptr[i]);
    }
  }
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: chain_connections
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_controller_manager_msgs__msg__ChainConnection(
        &array_ptr[i], cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: chain_connections
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_controller_manager_msgs__msg__ChainConnection(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: chain_connections
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_controller_manager_msgs__msg__ChainConnection(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const controller_manager_msgs__msg__ControllerState * ros_message = static_cast<const controller_manager_msgs__msg__ControllerState *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_controller_manager_msgs__msg__ControllerState(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  controller_manager_msgs__msg__ControllerState * ros_message = static_cast<controller_manager_msgs__msg__ControllerState *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_controller_manager_msgs__msg__ControllerState(cdr, ros_message);
}
