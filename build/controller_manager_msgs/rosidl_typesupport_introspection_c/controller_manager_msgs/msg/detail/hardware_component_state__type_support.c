...
static rosidl_typesupport_introspection_c__MessageMember controller_manager_msgs__msg__HardwareComponentState__rosidl_typesupport_introspection_c__HardwareComponentState_message_member_array[9] = {
  {
    "name",  // name
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, controller_manager_msgs, msg, HardwareComponentState)() {
  ...
  controller_manager_msgs__msg__HardwareComponentState__rosidl_typesupport_introspection_c__HardwareComponentState_message_member_array[8].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, controller_manager_msgs, msg, HardwareInterface)();
