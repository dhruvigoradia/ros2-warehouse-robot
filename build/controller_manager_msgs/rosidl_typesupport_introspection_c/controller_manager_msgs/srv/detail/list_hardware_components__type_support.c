...
void controller_manager_msgs__srv__ListHardwareComponents_Event__rosidl_typesupport_introspection_c__ListHardwareComponents_Event_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  controller_manager_msgs__srv__ListHardwareComponents_Event__init(message_memory);
}

void controller_manager_msgs__srv__ListHardwareComponents_Event__rosidl_typesupport_introspection_c__ListHardwareComponents_Event_fini_function(void * message_memory)
{
  controller_manager_msgs__srv__ListHardwareComponents_Event__fini(message_memory);
}

size_t controller_manager_msgs__srv__ListHardwareComponents_Event__rosidl_typesupport_introspection_c__size_function__ListHardwareComponents_Event__request(
  const void * untyped_member)
{
  const controller_manager_msgs__srv__ListHardwareComponents_Request__Sequence * member =
    (const controller_manager_msgs__srv__ListHardwareComponents_Request__Sequence *)(untyped_member);
  return member->size;
}

const void * controller_manager_msgs__srv__ListHardwareComponents_Event__rosidl_typesupport_introspection_c__get_const_function__ListHardwareComponents_Event__request(
  const void * untyped_member, size_t index)
{
  const controller_manager_msgs__srv__ListHardwareComponents_Request__Sequence * member =
    (const controller_manager_msgs__srv__ListHardwareComponents_Request__Sequence *)(untyped_member);
...
void * controller_manager_msgs__srv__ListHardwareComponents_Event__rosidl_typesupport_introspection_c__get_function__ListHardwareComponents_Event__request(
  void * untyped_member, size_t index)
{
  controller_manager_msgs__srv__ListHardwareComponents_Request__Sequence * member =
    (controller_manager_msgs__srv__ListHardwareComponents_Request__Sequence *)(untyped_member);
  return &member->data[index];
}

void controller_manager_msgs__srv__ListHardwareComponents_Event__rosidl_typesupport_introspection_c__fetch_function__ListHardwareComponents_Event__request(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const controller_manager_msgs__srv__ListHardwareComponents_Request * item =
    ((const controller_manager_msgs__srv__ListHardwareComponents_Request *)
    controller_manager_msgs__srv__ListHardwareComponents_Event__rosidl_typesupport_introspection_c__get_const_function__ListHardwareComponents_Event__request(untyped_member, index));
  controller_manager_msgs__srv__ListHardwareComponents_Request * value =
    (controller_manager_msgs__srv__ListHardwareComponents_Request *)(untyped_value);
  *value = *item;
}

void controller_manager_msgs__srv__ListHardwareComponents_Event__rosidl_typesupport_introspection_c__assign_function__ListHardwareComponents_Event__request(
  void * untyped_member, size_t index, const void * untyped_value)
{
  controller_manager_msgs__srv__ListHardwareComponents_Request * item =
    ((controller_manager_msgs__srv__ListHardwareComponents_Request *)
    controller_manager_msgs__srv__ListHardwareComponents_Event__rosidl_typesupport_introspection_c__get_function__ListHardwareComponents_Event__request(untyped_member, index));
  const controller_manager_msgs__srv__ListHardwareComponents_Request * value =
    (const controller_manager_msgs__srv__ListHardwareComponents_Request *)(untyped_value);
  *item = *value;
}

bool controller_manager_msgs__srv__ListHardwareComponents_Event__rosidl_typesupport_introspection_c__resize_function__ListHardwareComponents_Event__request(
  void * untyped_member, size_t size)
{
  controller_manager_msgs__srv__ListHardwareComponents_Request__Sequence * member =
    (controller_manager_msgs__srv__ListHardwareComponents_Request__Sequence *)(untyped_member);
  controller_manager_msgs__srv__ListHardwareComponents_Request__Sequence__fini(member);
  return controller_manager_msgs__srv__ListHardwareComponents_Request__Sequence__init(member, size);
}

size_t controller_manager_msgs__srv__ListHardwareComponents_Event__rosidl_typesupport_introspection_c__size_function__ListHardwareComponents_Event__response(
  const void * untyped_member)
{
  const controller_manager_msgs__srv__ListHardwareComponents_Response__Sequence * member =
    (const controller_manager_msgs__srv__ListHardwareComponents_Response__Sequence *)(untyped_member);
  return member->size;
}

const void * controller_manager_msgs__srv__ListHardwareComponents_Event__rosidl_typesupport_introspection_c__get_const_function__ListHardwareComponents_Event__response(
  const void * untyped_member, size_t index)
{
  const controller_manager_msgs__srv__ListHardwareComponents_Response__Sequence * member =
    (const controller_manager_msgs__srv__ListHardwareComponents_Response__Sequence *)(untyped_member);
...
void * controller_manager_msgs__srv__ListHardwareComponents_Event__rosidl_typesupport_introspection_c__get_function__ListHardwareComponents_Event__response(
  void * untyped_member, size_t index)
{
  controller_manager_msgs__srv__ListHardwareComponents_Response__Sequence * member =
    (controller_manager_msgs__srv__ListHardwareComponents_Response__Sequence *)(untyped_member);
  return &member->data[index];
}

void controller_manager_msgs__srv__ListHardwareComponents_Event__rosidl_typesupport_introspection_c__fetch_function__ListHardwareComponents_Event__response(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const controller_manager_msgs__srv__ListHardwareComponents_Response * item =
    ((const controller_manager_msgs__srv__ListHardwareComponents_Response *)
    controller_manager_msgs__srv__ListHardwareComponents_Event__rosidl_typesupport_introspection_c__get_const_function__ListHardwareComponents_Event__response(untyped_member, index));
  controller_manager_msgs__srv__ListHardwareComponents_Response * value =
    (controller_manager_msgs__srv__ListHardwareComponents_Response *)(untyped_value);
  *value = *item;
}

void controller_manager_msgs__srv__ListHardwareComponents_Event__rosidl_typesupport_introspection_c__assign_function__ListHardwareComponents_Event__response(
  void * untyped_member, size_t index, const void * untyped_value)
{
  controller_manager_msgs__srv__ListHardwareComponents_Response * item =
    ((controller_manager_msgs__srv__ListHardwareComponents_Response *)
    controller_manager_msgs__srv__ListHardwareComponents_Event__rosidl_typesupport_introspection_c__get_function__ListHardwareComponents_Event__response(untyped_member, index));
  const controller_manager_msgs__srv__ListHardwareComponents_Response * value =
    (const controller_manager_msgs__srv__ListHardwareComponents_Response *)(untyped_value);
  *item = *value;
}

bool controller_manager_msgs__srv__ListHardwareComponents_Event__rosidl_typesupport_introspection_c__resize_function__ListHardwareComponents_Event__response(
  void * untyped_member, size_t size)
{
  controller_manager_msgs__srv__ListHardwareComponents_Response__Sequence * member =
    (controller_manager_msgs__srv__ListHardwareComponents_Response__Sequence *)(untyped_member);
  controller_manager_msgs__srv__ListHardwareComponents_Response__Sequence__fini(member);
  return controller_manager_msgs__srv__ListHardwareComponents_Response__Sequence__init(member, size);
}

static rosidl_typesupport_introspection_c__MessageMember controller_manager_msgs__srv__ListHardwareComponents_Event__rosidl_typesupport_introspection_c__ListHardwareComponents_Event_message_member_array[3] = {
  {
    "info",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(controller_manager_msgs__srv__ListHardwareComponents_Event, info),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    1,  // array size
    true,  // is upper bound
    offsetof(controller_manager_msgs__srv__ListHardwareComponents_Event, request),  // bytes offset in struct
    NULL,  // default value
    controller_manager_msgs__srv__ListHardwareComponents_Event__rosidl_typesupport_introspection_c__size_function__ListHardwareComponents_Event__request,  // size() function pointer
    controller_manager_msgs__srv__ListHardwareComponents_Event__rosidl_typesupport_introspection_c__get_const_function__ListHardwareComponents_Event__request,  // get_const(index) function pointer
    controller_manager_msgs__srv__ListHardwareComponents_Event__rosidl_typesupport_introspection_c__get_function__ListHardwareComponents_Event__request,  // get(index) function pointer
    controller_manager_msgs__srv__ListHardwareComponents_Event__rosidl_typesupport_introspection_c__fetch_function__ListHardwareComponents_Event__request,  // fetch(index, &value) function pointer
    controller_manager_msgs__srv__ListHardwareComponents_Event__rosidl_typesupport_introspection_c__assign_function__ListHardwareComponents_Event__request,  // assign(index, value) function pointer
    controller_manager_msgs__srv__ListHardwareComponents_Event__rosidl_typesupport_introspection_c__resize_function__ListHardwareComponents_Event__request  // resize(index) function pointer
  },
  {
    "response",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_MESSAGE,  // type
    ...
    1,  // array size
    true,  // is upper bound
    offsetof(controller_manager_msgs__srv__ListHardwareComponents_Event, response),  // bytes offset in struct
    NULL,  // default value
    controller_manager_msgs__srv__ListHardwareComponents_Event__rosidl_typesupport_introspection_c__size_function__ListHardwareComponents_Event__response,  // size() function pointer
    controller_manager_msgs__srv__ListHardwareComponents_Event__rosidl_typesupport_introspection_c__get_const_function__ListHardwareComponents_Event__response,  // get_const(index) function pointer
    controller_manager_msgs__srv__ListHardwareComponents_Event__rosidl_typesupport_introspection_c__get_function__ListHardwareComponents_Event__response,  // get(index) function pointer
    controller_manager_msgs__srv__ListHardwareComponents_Event__rosidl_typesupport_introspection_c__fetch_function__ListHardwareComponents_Event__response,  // fetch(index, &value) function pointer
    controller_manager_msgs__srv__ListHardwareComponents_Event__rosidl_typesupport_introspection_c__assign_function__ListHardwareComponents_Event__response,  // assign(index, value) function pointer
    controller_manager_msgs__srv__ListHardwareComponents_Event__rosidl_typesupport_introspection_c__resize_function__ListHardwareComponents_Event__response  // resize(index) function pointer
  }
};

static const rosidl_typesupport_introspection_c__MessageMembers controller_manager_msgs__srv__ListHardwareComponents_Event__rosidl_typesupport_introspection_c__ListHardwareComponents_Event_message_members = {
  "controller_manager_msgs__srv",  // message namespace
  "ListHardwareComponents_Event",  // message name
  3,  // number of fields
  sizeof(controller_manager_msgs__srv__ListHardwareComponents_Event),
  false,  // has_any_key_member_
  controller_manager_msgs__srv__ListHardwareComponents_Event__rosidl_typesupport_introspection_c__ListHardwareComponents_Event_message_member_array,  // message members
  controller_manager_msgs__srv__ListHardwareComponents_Event__rosidl_typesupport_introspection_c__ListHardwareComponents_Event_init_function,  // function to initialize message memory (memory has to be allocated)
  controller_manager_msgs__srv__ListHardwareComponents_Event__rosidl_typesupport_introspection_c__ListHardwareComponents_Event_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t controller_manager_msgs__srv__ListHardwareComponents_Event__rosidl_typesupport_introspection_c__ListHardwareComponents_Event_message_type_support_handle = {
  0,
  &controller_manager_msgs__srv__ListHardwareComponents_Event__rosidl_typesupport_introspection_c__ListHardwareComponents_Event_message_members,
  get_message_typesupport_handle_function,
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_controller_manager_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, controller_manager_msgs, srv, ListHardwareComponents_Event)() {
  controller_manager_msgs__srv__ListHardwareComponents_Event__rosidl_typesupport_introspection_c__ListHardwareComponents_Event_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, service_msgs, msg, ServiceEventInfo)();
  controller_manager_msgs__srv__ListHardwareComponents_Event__rosidl_typesupport_introspection_c__ListHardwareComponents_Event_message_member_array[1].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, controller_manager_msgs, srv, ListHardwareComponents_Request)();
  controller_manager_msgs__srv__ListHardwareComponents_Event__rosidl_typesupport_introspection_c__ListHardwareComponents_Event_message_member_array[2].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, controller_manager_msgs, srv, ListHardwareComponents_Response)();
  if (!controller_manager_msgs__srv__ListHardwareComponents_Event__rosidl_typesupport_introspection_c__ListHardwareComponents_Event_message_type_support_handle.typesupport_identifier) {
    controller_manager_msgs__srv__ListHardwareComponents_Event__rosidl_typesupport_introspection_c__ListHardwareComponents_Event_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &controller_manager_msgs__srv__ListHardwareComponents_Event__rosidl_typesupport_introspection_c__ListHardwareComponents_Event_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
...
static rosidl_service_type_support_t controller_manager_msgs__srv__detail__list_hardware_components__rosidl_typesupport_introspection_c__ListHardwareComponents_service_type_support_handle = {
  ...
  &controller_manager_msgs__srv__ListHardwareComponents_Request__rosidl_typesupport_introspection_c__ListHardwareComponents_Request_message_type_support_handle,
  &controller_manager_msgs__srv__ListHardwareComponents_Response__rosidl_typesupport_introspection_c__ListHardwareComponents_Response_message_type_support_handle,
  &controller_manager_msgs__srv__ListHardwareComponents_Event__rosidl_typesupport_introspection_c__ListHardwareComponents_Event_message_type_support_handle,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, controller_manager_msgs, srv, ListHardwareComponents_Request)(void);

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, controller_manager_msgs, srv, ListHardwareComponents_Response)(void);

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, controller_manager_msgs, srv, ListHardwareComponents_Event)(void);

ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_controller_manager_msgs
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, controller_manager_msgs, srv, ListHardwareComponents)(void) {
  ...
  if (!service_members->event_members_) {
    service_members->event_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, controller_manager_msgs, srv, ListHardwareComponents_Event)()->data;
  }
