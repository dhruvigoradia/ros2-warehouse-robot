...
controller_manager_msgs__srv__UnloadController_Request__create(void)
{
...
controller_manager_msgs__srv__UnloadController_Response__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
...
controller_manager_msgs__srv__UnloadController_Event__init(controller_manager_msgs__srv__UnloadController_Event * msg)
{
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    controller_manager_msgs__srv__UnloadController_Event__fini(msg);
    return false;
  }
  // request
  if (!controller_manager_msgs__srv__UnloadController_Request__Sequence__init(&msg->request, 0)) {
    controller_manager_msgs__srv__UnloadController_Event__fini(msg);
    return false;
  }
  // response
  if (!controller_manager_msgs__srv__UnloadController_Response__Sequence__init(&msg->response, 0)) {
    controller_manager_msgs__srv__UnloadController_Event__fini(msg);
    return false;
  }
  return true;
...
controller_manager_msgs__srv__UnloadController_Event__fini(controller_manager_msgs__srv__UnloadController_Event * msg)
{
  ...
  // request
  controller_manager_msgs__srv__UnloadController_Request__Sequence__fini(&msg->request);
  // response
  controller_manager_msgs__srv__UnloadController_Response__Sequence__fini(&msg->response);
}
...
controller_manager_msgs__srv__UnloadController_Event__are_equal(const controller_manager_msgs__srv__UnloadController_Event * lhs, const controller_manager_msgs__srv__UnloadController_Event * rhs)
{
  ...
  // request
  if (!controller_manager_msgs__srv__UnloadController_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!controller_manager_msgs__srv__UnloadController_Response__Sequence__are_equal(
  ...
  controller_manager_msgs__srv__UnloadController_Event * output)
{
  ...
  // request
  if (!controller_manager_msgs__srv__UnloadController_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!controller_manager_msgs__srv__UnloadController_Response__Sequence__copy(
...
controller_manager_msgs__srv__UnloadController_Event__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  controller_manager_msgs__srv__UnloadController_Event * msg = (controller_manager_msgs__srv__UnloadController_Event *)allocator.allocate(sizeof(controller_manager_msgs__srv__UnloadController_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(controller_manager_msgs__srv__UnloadController_Event));
  bool success = controller_manager_msgs__srv__UnloadController_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
controller_manager_msgs__srv__UnloadController_Event__Sequence__init(controller_manager_msgs__srv__UnloadController_Event__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  controller_manager_msgs__srv__UnloadController_Event * data = NULL;

  if (size) {
    data = (controller_manager_msgs__srv__UnloadController_Event *)allocator.zero_allocate(size, sizeof(controller_manager_msgs__srv__UnloadController_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = controller_manager_msgs__srv__UnloadController_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        controller_manager_msgs__srv__UnloadController_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
controller_manager_msgs__srv__UnloadController_Event__Sequence__fini(controller_manager_msgs__srv__UnloadController_Event__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      controller_manager_msgs__srv__UnloadController_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  controller_manager_msgs__srv__UnloadController_Event__Sequence * array = (controller_manager_msgs__srv__UnloadController_Event__Sequence *)allocator.allocate(sizeof(controller_manager_msgs__srv__UnloadController_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = controller_manager_msgs__srv__UnloadController_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
controller_manager_msgs__srv__UnloadController_Event__Sequence__destroy(controller_manager_msgs__srv__UnloadController_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    controller_manager_msgs__srv__UnloadController_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
controller_manager_msgs__srv__UnloadController_Event__Sequence__are_equal(const controller_manager_msgs__srv__UnloadController_Event__Sequence * lhs, const controller_manager_msgs__srv__UnloadController_Event__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!controller_manager_msgs__srv__UnloadController_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  controller_manager_msgs__srv__UnloadController_Event__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(controller_manager_msgs__srv__UnloadController_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    controller_manager_msgs__srv__UnloadController_Event * data =
      (controller_manager_msgs__srv__UnloadController_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!controller_manager_msgs__srv__UnloadController_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          controller_manager_msgs__srv__UnloadController_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!controller_manager_msgs__srv__UnloadController_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
