...
size_t size_function__ControllerState__exported_state_interfaces(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<std::string> *>(untyped_member);
  return member->size();
}

const void * get_const_function__ControllerState__exported_state_interfaces(const void * untyped_member, size_t index)
{
  const auto & member =
    *reinterpret_cast<const std::vector<std::string> *>(untyped_member);
  return &member[index];
...
void * get_function__ControllerState__exported_state_interfaces(void * untyped_member, size_t index)
{
  auto & member =
    *reinterpret_cast<std::vector<std::string> *>(untyped_member);
  return &member[index];
...
void fetch_function__ControllerState__exported_state_interfaces(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const std::string *>(
    get_const_function__ControllerState__exported_state_interfaces(untyped_member, index));
  auto & value = *reinterpret_cast<std::string *>(untyped_value);
  value = item;
}

void assign_function__ControllerState__exported_state_interfaces(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<std::string *>(
    get_function__ControllerState__exported_state_interfaces(untyped_member, index));
  const auto & value = *reinterpret_cast<const std::string *>(untyped_value);
  item = value;
}

void resize_function__ControllerState__exported_state_interfaces(void * untyped_member, size_t size)
{
  auto * member =
    reinterpret_cast<std::vector<std::string> *>(untyped_member);
  member->resize(size);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ControllerState_message_member_array[13] = {
  {
    "name",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(controller_manager_msgs::msg::ControllerState, is_async),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(controller_manager_msgs::msg::ControllerState, update_rate),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(controller_manager_msgs::msg::ControllerState, exported_state_interfaces),  // bytes offset in struct
    nullptr,  // default value
    size_function__ControllerState__exported_state_interfaces,  // size() function pointer
    get_const_function__ControllerState__exported_state_interfaces,  // get_const(index) function pointer
    get_function__ControllerState__exported_state_interfaces,  // get(index) function pointer
    fetch_function__ControllerState__exported_state_interfaces,  // fetch(index, &value) function pointer
    assign_function__ControllerState__exported_state_interfaces,  // assign(index, value) function pointer
    resize_function__ControllerState__exported_state_interfaces  // resize(index) function pointer
  },
  {
