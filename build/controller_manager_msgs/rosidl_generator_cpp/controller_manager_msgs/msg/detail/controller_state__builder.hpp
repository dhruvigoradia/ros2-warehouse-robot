...
class Init_ControllerState_exported_state_interfaces
{
public:
  explicit Init_ControllerState_exported_state_interfaces(::controller_manager_msgs::msg::ControllerState & msg)
  : msg_(msg)
  {}
  Init_ControllerState_reference_interfaces exported_state_interfaces(::controller_manager_msgs::msg::ControllerState::_exported_state_interfaces_type arg)
  {
    msg_.exported_state_interfaces = std::move(arg);
...
public:
  ...
  : msg_(msg)
  {}
  Init_ControllerState_exported_state_interfaces is_chained(::controller_manager_msgs::msg::ControllerState::_is_chained_type arg)
  {
    msg_.is_chained = std::move(arg);
    return Init_ControllerState_exported_state_interfaces(msg_);
  }
...
class Init_ControllerState_update_rate
{
public:
  explicit Init_ControllerState_update_rate(::controller_manager_msgs::msg::ControllerState & msg)
  : msg_(msg)
  {}
  Init_ControllerState_claimed_interfaces update_rate(::controller_manager_msgs::msg::ControllerState::_update_rate_type arg)
  {
...
class Init_ControllerState_is_async
{
public:
  explicit Init_ControllerState_is_async(::controller_manager_msgs::msg::ControllerState & msg)
  : msg_(msg)
  {}
  Init_ControllerState_update_rate is_async(::controller_manager_msgs::msg::ControllerState::_is_async_type arg)
  {
    msg_.is_async = std::move(arg);
    return Init_ControllerState_update_rate(msg_);
  }
...
public:
  ...
  : msg_(msg)
  {}
  Init_ControllerState_is_async type(::controller_manager_msgs::msg::ControllerState::_type_type arg)
  {
    msg_.type = std::move(arg);
    return Init_ControllerState_is_async(msg_);
  }
